        ...
        <div className='projects__title react'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              ...
              <p>React</p>
              <a className='btn' href="https://eloquent-aryabhata-f6b832.netlify.app"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title css'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              <h3>Tribute Page</h3>
              <p>HTML / CSS</p>
              <a className='btn' href="https://codepen.io/franadam/full/PooLjwK"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title css'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              <h3>Survey Form</h3>
              <p>HTML / CSS</p>
              <a className='btn' href="https://codepen.io/franadam/full/BaabPJx"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title css'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              ...
              <p>HTML / CSS</p>
              <a className='btn' href="https://codepen.io/franadam/full/qBBwRKZ"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title react'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              ...
              <p>React</p>
              <a className='btn' href="https://codepen.io/franadam/full/eYmMeJd"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title react'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              ...
              <p>React</p>
              <a className='btn' href="https://codepen.io/franadam/full/WNbJvQz"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title d3'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              <h3>Bar Chart</h3>
              <p>D3</p>
              <a className='btn' href="https://codepen.io/franadam/full/GRJqLEz"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
        ...
        <div className='projects__title d3'>
          ...
          <div className="overlay">
            <div className="overlay__text">
              ...
              <p>D3</p>
              <a className='btn' href="https://codepen.io/franadam/full/Exjgoag"
                target="_blank" rel="noopener noreferrer" >See Page</a>
            </div>
          </div>
        </div>
